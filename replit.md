...
- July 18, 2025. **WIDGET OFICIAL GOOGLE TRANSLATE IMPLEMENTADO** - Reemplazado sistema de traducción personalizado por widget oficial de Google Translate integrado directamente en el navbar. Funciona tanto en desktop como móvil, traduce la página instantáneamente al seleccionar idioma, incluye 14 idiomas principales (ES, EN, FR, DE, IT, PT, CA, EU, GL, ZH, AR, JA, KO, RU, HI), oculta banner de Google Translate, estilos personalizados para integrar con diseño NFLOW, y selector nativo que aparece junto al icono de idiomas.
