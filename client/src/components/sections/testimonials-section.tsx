...
const testimonials = [
  {
    ...
    name: "Safa",
    initial: "S",
    comment: "No me arrepiento de haber usado NUXA. Un muy buen servicio profesional. Todo dicho, mucha motivación.",
  ...
  },
  {
    ...
    name: "M.Angel",
    initial: "M",
    comment: "NUXA ha sido un lujo conectar con este nivel profesional. El asistente IA tiene todos los puntos para recomendarlo.",
  ...
  },
  {
    ...
    name: "Ana",
    initial: "A", 
    comment: "A pesar de que llevo pocas sesiones todas han sido muy reconfortantes, creo que con NUXA conseguiré estar bien y superar mi ansiedad para poder tener una vida normal y tranquila.",
    service: "Diagnóstico y tratamiento para trastornos de ansiedad",
  ...
  },
  {
    ...
    name: "Xavi",
    initial: "X",
    comment: "Molt bon servei professional. Content d'haver fet el tractament amb NUXA.",
    service: "Diagnóstico y tratamiento para trastornos de ansiedad",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Miles de personas ya han mejorado su bienestar mental con NUXA. 
