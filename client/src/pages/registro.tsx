...
const individualPlans = [
  {
    ...
    badge: null,
    icon: Calendar,
    features: ["30 preguntas al mes", "Respuestas en +150 idiomas", "Soporte básico 24/7", "Acceso a recursos gratuitos"],
  },
  {
    id: "pro",
    name: "Plan Pro",
    price: "€5.99",
    period: "/mes",
    questions: "100 preguntas/mes",
    color: "from-purple-500 to-indigo-700",
    border: "border-purple-300",
    badge: "Más popular",
    icon: User,
    features: ["100 preguntas al mes", "Respuestas en +150 idiomas", "Soporte prioritario 24/7", "Acceso a todos los recursos", "Historial completo"],
  },
  {
    id: "premium",
    name: "Plan Anual",
