...
- **Free Resources Section - Recursos Gratis (30/9/2025)**: Implementada nueva sección de recursos gratuitos inspirada en Yana app para aumentar engagement y conversiones pre-suscripción. Página /recursos accesible sin autenticación que ofrece: 6 actividades diarias interactivas (ejercicio emocional, afirmaciones, chats guiados, evaluaciones), sección de evaluaciones profesionales (ansiedad, depresión, autoestima), afirmaciones visuales del día con ilustraciones y funcionalidad de compartir/descargar, sistema de racha diaria con tracking emocional. Todos los modales redirigen a /login para conversión. Agregado ítem "Recursos Gratis" con ícono Gift al menú hamburguesa. Funcionalidad completa probada end-to-end con playwright: navegación, apertura de modales, y redirect exitoso.
