...
Changelog:
- July 19, 2025. **TARJETA PRINCIPAL OPTIMIZADA** - Reorganizado layout de MentalHealthHeroSection con imagen a la izquierda y texto a la derecha. Eliminado párrafo descriptivo y característica "Para Toda la Familia/Apoyo integral desde los 12 años" para diseño más limpio. Imagen aumentada 15% para mejor balance visual. Ahora muestra solo características esenciales: 100% Confidencial, Profesional, Disponible 24/7 con botón "Ejemplos de NFlow".
