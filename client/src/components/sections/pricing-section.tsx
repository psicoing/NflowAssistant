        ...
        <div className="text-center mb-12">
          ...
          {(isNewUser || isPendingPayment) && (
            <div className="mt-6 space-y-4">
              <div className="p-4 bg-nflow-orange/20 border border-nflow-orange/30 rounded-xl max-w-lg mx-auto">
                <p className="text-nflow-orange font-semibold text-center mb-2">
              ...
              <div className="p-4 bg-green-900/20 border border-green-500/30 rounded-xl max-w-lg mx-auto">
                <div className="flex items-center justify-center mb-3">
                  ...
                  <h4 className="text-green-400 font-semibold">2º Opción: Activación Manual</h4>
                </div>
