...
- July 18, 2025. **WIDGET OFICIAL GOOGLE TRANSLATE COMPLETADO** - Reemplazado sistema de traducción personalizado por widget oficial de Google Translate integrado directamente en navbar principal. Funciona perfectamente en desktop y móvil, traduce la página instantáneamente al seleccionar idioma, incluye 14 idiomas principales (ES, EN, FR, DE, IT, PT, CA, EU, GL, ZH, AR, JA, KO, RU, HI), oculta banner de Google Translate, estilos personalizados (140px x 32px) con texto blanco, posicionado en barra superior entre indicador de conexión y botones de autenticación. Componente móvil removido del menú hamburguesa por solicitud del usuario.
