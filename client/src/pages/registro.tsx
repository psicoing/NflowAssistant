      ...
      <div className="w-full max-w-md relative z-10">
        <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm shadow-2xl">
          <CardHeader className="text-center">
            ...
            {/* Privacy Notice - Compact on mobile */}
            <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-emerald-900/30 border border-emerald-700/50 rounded-lg">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400 flex-shrink-0" />
                <p className="text-[10px] sm:text-xs text-emerald-300/90 leading-tight sm:leading-relaxed">
                  <span className="font-semibold text-emerald-400">100% Confidencial.</span>
                  <span className="hidden sm:inline"> Email solo para pago. No enviamos confirmaciones ni correos de recuperación.</span>
                  <span className="sm:hidden"> Email solo para pago.</span>
                  <span className="font-semibold"> Todo queda entre tú y NUXA.</span>
                </p>
              </div>
            </div>
            
            {/* Mobile Payment Info - Compact single line */}
            <div className="lg:hidden mt-2 sm:mt-3 py-2 px-3 bg-gradient-to-r from-blue-600/20 to-emerald-600/20 border border-purple-500/30 rounded-lg">
              <p className="text-gray-300 text-center text-[10px] sm:text-xs">
                <span className="text-blue-400 font-medium">Suscripción</span> ó <span className="text-emerald-400 font-medium">créditos</span> · Elige después del registro
              </p>
            </div>
          </CardHeader>
