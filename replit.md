...
Changelog:
- July 20, 2025. **ERROR JSX CRÍTICO RESUELTO** - Error "Objects are not valid as a React child (found: object with keys {label, onClick})" solucionado completamente. Problema localizado en login.tsx líneas 74-77 donde componente toast recibía objeto action mal estructurado. Eliminado objeto problemático y reemplazado por redirección automática limpia. Usuario nuevo creado: usuarionuevo/password con suscripción activa para pruebas.
