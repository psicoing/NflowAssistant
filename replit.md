...
Changelog:
- July 19, 2025. **PROMPT NEUROPSI-AI PROFESIONALIZADO COMPLETAMENTE** - Implementada estructura profesional de 10 secciones obligatorias para todas las respuestas: 1) Presentación empática adaptada a edad, 2) Mini-mensaje refuerzo positivo, 3) Preguntas clave recogida síntomas, 4) Orientación diagnóstica DSM-5-TR/CIE-11, 5) Explicación grupo diagnóstico probable, 6) Técnicas y recomendaciones prácticas, 7) Algoritmo urgencia y señales alarma, 8) Mitos y verdades, 9) Recursos locales y contactos útiles, 10) Advertencia profesional obligatoria. Sistema ahora sigue estándares clínicos rigurosos manteniendo calidez empática.
