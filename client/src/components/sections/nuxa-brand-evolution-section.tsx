...
export default function NuxaBrandEvolutionSection() {
  return (
    <section className="relative bg-gradient-to-br from-orange-100 via-amber-50 to-yellow-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-16 md:py-20">
      {/* Background Pattern */}
