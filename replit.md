...
Changelog:
- July 17, 2025. **TARJETA SALUD MENTAL AGREGADA COMO PRIMERA** - Implementada nueva sección MentalHealthHeroSection como primer elemento con imagen elegante de familia usando NFLOW. Incluye gradientes modernos, características clave (Para Toda la Familia, 100% Confidencial, Profesional, Disponible 24/7), indicador de apoyo activo y elementos decorativos. Posicionada antes del banner multiidioma para máximo impacto visual.
