...
export default function PsychologySeal({ size = 220 }: { size?: number }) {
  ...
  return (
    ...
    >
      ...
      <text x={C} y={160} textAnchor="middle" fontFamily="'Georgia','Times New Roman',serif" fontSize="6.5" fill={navy} letterSpacing="0.5">MEDICINES AGENCY TMT · A1</text>
      <text x={C} y={170} textAnchor="middle" fontFamily="'Georgia','Times New Roman',serif" fontSize="7" fontWeight="bold" fill={navy} letterSpacing="1">HEALTH LICENSE</text>
      <text x={C} y={180} textAnchor="middle" fontFamily="'Georgia','Times New Roman',serif" fontSize="6.5" fill={navy} letterSpacing="0.6">E-179287705</text>
    </svg>
  );
}
