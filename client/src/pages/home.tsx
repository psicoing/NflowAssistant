  ...
  return (
    <div className="min-h-screen bg-nflow-dark">
      ...
      <main className="pt-16">
        ...
        <section className="py-14 bg-gradient-to-b from-gray-950 to-slate-900">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <span className="inline-flex items-center gap-2 bg-emerald-500/15 border border-emerald-400/25 rounded-full px-4 py-1.5 text-emerald-300 text-sm font-medium mb-4">
                🛠️ Herramientas gratuitas
              </span>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Sin registro. Sin tarjeta.</h2>
