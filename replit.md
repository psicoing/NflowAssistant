...
- **Video Demo Cross-Browser Compatibility (29/9/2025)**: Solucionados problemas críticos de compatibilidad de video entre navegadores (Edge se congela, Firefox errores MIME). Simplificada completamente la sección de demo NEUROPSI-AI eliminando modal de expansión, botones interactivos y lógica JavaScript compleja. Implementado autoplay HTML nativo (autoplay, muted, loop, playsInline) con archivo renombrado ASCII-seguro (neuropsi-demo-video.mp4). Video ahora reproduce continuamente dentro del marco del TV sin controles, garantizando experiencia consistente en Edge, Firefox, Chrome y otros navegadores sin errores de reproductores nativos.
