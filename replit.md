...
Changelog:
- July 20, 2025. **ERROR JSX CRÍTICO PENDIENTE** - Error "Objects are not valid as a React child (found: object with keys {label, onClick})" persiste en menú de usuario del chat a pesar de correcciones múltiples. Se recomienda redeploy funcional para restaurar estabilidad del sistema. Error afecta acceso al chat causando desaparición de la página.
